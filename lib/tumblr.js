...
const fetchTumblrPosts = async (parseFn = parseTumblrPost) => {
  try {
    ...
    let tumblrUrl = `https://api.tumblr.com/v2/blog/${TUMBLR_BLOG_NAME}/posts/?tag=${TUMBLR_TAG}&api_key=${TUMBLR_API_KEY}`;
